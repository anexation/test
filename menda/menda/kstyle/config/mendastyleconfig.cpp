...
extern "C"
{
    ...
    { return new Menda::StyleConfig(parent); }
}
...
namespace Menda
{
    ...
    void StyleConfig::save( void )
    {
        ...
        // emit dbus signal
        QDBusMessage message( QDBusMessage::createSignal( QStringLiteral( "/MendaStyle" ),  QStringLiteral( "org.kde.Menda.Style" ), QStringLiteral( "reparseConfiguration" ) ) );

#ifndef menda_helper_h
#define menda_helper_h
...
namespace Menda
{
    ...
    //* menda style helper class.
    /** contains utility functions used at multiple places in both menda style and menda window decoration */
    class Helper
    {
        public:

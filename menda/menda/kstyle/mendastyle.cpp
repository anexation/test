...
namespace MendaPrivate
{
    ...
    class TabBarData: public QObject
    {
        ...
        Menda::WeakPointer<const QWidget> _tabBar;
    ...
    class ComboBoxItemDelegate: public QItemDelegate
    {
        ...
        ComboBoxItemDelegate( QAbstractItemView* parent ):
            ...
            _itemMargin( Menda::Metrics::ItemView_ItemMarginWidth )
        {}
        ...
        //* proxy
        Menda::WeakPointer<QAbstractItemDelegate> _proxy;
...
namespace Menda
{
    ...
    Style::Style( void ):
        ...
        , _tabBarData( new MendaPrivate::TabBarData( this ) )
        #if MENDA_HAVE_KSTYLE
        , SH_ArgbDndWindow( newStyleHint( QStringLiteral( "SH_ArgbDndWindow" ) ) )
        , CE_CapacityBar( newControlElement( QStringLiteral( "CE_CapacityBar" ) ) )
        #endif
    {

        // use DBus connection to update on menda configuration change
        QDBusConnection dbus = QDBusConnection::sessionBus();
        dbus.connect( QString(),
            QStringLiteral( "/MendaStyle" ),
            QStringLiteral( "org.kde.Menda.Style" ),
    ...
    void Style::polish( QWidget* widget )
    {
        ...
        if( qobject_cast<QScrollBar*>( widget ) )
        {
            ...
            if( !hasParent( widget, "QWebView" ) )
            {
                ...
                { itemView->setItemDelegate( new MendaPrivate::ComboBoxItemDelegate( itemView ) ); }
            }

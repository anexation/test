...
namespace Menda
{
    ...
    int Decoration::buttonHeight() const
    {
        ...
        {
            case Menda::InternalSettings::ButtonSmall: return baseSize*1.5;
            default:
            case Menda::InternalSettings::ButtonDefault: return baseSize*2;
            case Menda::InternalSettings::ButtonLarge: return baseSize*2.5;
            case Menda::InternalSettings::ButtonVeryLarge: return baseSize*3.5;
        }
